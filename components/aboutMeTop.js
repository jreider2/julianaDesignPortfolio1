...
export default function AboutMeTop({ children, home }) {
    return (
        ...
        <div className={styles.titleContainer}>
            ...
            </div><div className={styles.flexContainer2}>
                {/* Flexbox container 2 */}
            ...
            </div><div className={styles.flexContainer3}>
                {/* Flexbox container 3 */}
                <div className={styles.imageContainer}>
                    <Image src={profileImage} alt="Image" layout="intrinsic" />
                </div>
            ...
            </div><div className={styles.flexContainer4}>
                {/* Flexbox container 4 */}
            </div><div className={styles.flexContainer5}>
                {/* Flexbox container 5 */}
            </div>
        </div>
    );
